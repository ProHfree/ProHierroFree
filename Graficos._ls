...
(DEFUN C:DIBMARCAS (/ p1 p2 pp1 p12)
  ;PARA SETEAR A CERO EL VALOR DE PLINETYPE 2007-01-31 LC
  ;(setvar "clayer" layerdib)(setvar "cmdecho" 0)(setvar "blipmode" 0)(setvar "plinewid" 0)(setvar "osmode" 0)(setvar "plinetype" 0)
  (setvar "clayer" layerdib)(setvar "cmdecho" 0)(setvar "blipmode" 0)(setvar "plinewid" 0)(setvar "osmode" 0);CDPJ
  (setq opMARCAS 0)
  (SETQ DCL3 (LOAD_DIALOG "graficos.dcl"))
  ...
  (cond
	...
	(print "fin")
	(INITGET "Punto Continuar Salir Undo")
	(if p1
	  (progn
	    (setq opAL (GETKWORD "\nSeleccione opcion : Punto/<Continuar>/Exit/Undo : "))
	    (if (= opAL nil)(setq opAL "Continuar"))
	  )
	  (progn
	    (setq opAL (GETKWORD "\nSeleccione opcion : <Punto>/Continuar/Exit/Undo : "))
	    (if (= opAL nil)(setq opAL "Punto"))
	  )
	)
      )
  ...
  (setvar "cmdecho" old2)(setvar "blipmode" blipmodeANT)(setvar "clayer" layerANT)(setvar "plinewid" wideANT)(setvar "osmode" os)
)
;-----------------------
(DEFUN ARREVIGAS ()
  (cond
